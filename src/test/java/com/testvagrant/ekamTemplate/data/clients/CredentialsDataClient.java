...
public class CredentialsDataClient extends DataSetsClient {
    ...
    public Credentials getEmptyUser() { return getUser("empty"); }

    public Credentials getInvalidPasswordUser() { return getUser("empty").toBuilder().username("invalid").password("invalid").build(); }
